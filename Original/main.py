...
def main():
    ...
    if GetTimeOfDay() == "night":
        background = LoadUI("night_background",(ScreenWidth,ScreenHeight))
    else:
    ...
    NewsWidget = nm.Widget()
    NewsWidget.Launch(form,(45,200,220,40))
    ...
    while True:
        ...
        if GetTimeOfDay() == "night":
            text = timefont.render(currenttime, True, fontcolor[4])
        else:
            text = timefont.render(currenttime, True, fontcolor[0])
        form.blit(text, timerect)
